...
void display(void)
{
  //Reinicia el lienzo
   ...
   glColor3f(0.0, 0.0, 0.0);   E(-490,155);
   glColor3f(0.2, 0.0, 0.0);   R(-380,155);
   glColor3f(0.4, 0.0, 0.0);   I(-270,155);
   glColor3f(0.6, 0.0, 0.0);   C(-160,155);
   glColor3f(0.8, 0.0, 0.0);   K(-50,155);

   glColor3f(.01, 0.0, 0.0);   R(-490,30);
   glColor3f(0.0, 0.125, 0.0); I(-380,30);
   glColor3f(0.0, 0.5, 0.0);   V(-270,30);
   glColor3f(0.0, 0.5, 0.0);   A(-160,30);
   glColor3f(0.0, 0.5, 0.0);   S(-50,30);

   glColor3f(.02, 0.0, 0.0);   R(-490,-95);
   glColor3f(0.0, 0.0, .14);   E(-380,-96);
   glColor3f(0.0, 0.0, .29);   D(-270,-96);
   glColor3f(0.0, 0.0, .43);   O(-160,-96);
   glColor3f(0.0, 0.0, .57);   N(-50,-96);
   glColor3f(0.0, 0.0, .71);   D(60,-96);
   glColor3f(0.0, 0.0, .86);   A(170,-96);
